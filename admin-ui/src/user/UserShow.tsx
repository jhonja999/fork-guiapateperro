  ...
  return (
    <Show {...props}>
      <SimpleShowLayout>
        ...
        <ReferenceManyField reference="Evento" target="userId" label="eventos">
          <Datagrid rowClick="show">
            <DateField source="createdAt" label="Created At" />
            <TextField label="eventoinfo" source="eventoinfo" />
            <TextField label="ID" source="id" />
            <ReferenceField
              label="listing"
              source="listing.id"
        ...
        <ReferenceManyField reference="Lugar" target="userId" label="lugars">
          <Datagrid rowClick="show">
            <DateField source="createdAt" label="Created At" />
            <TextField label="ID" source="id" />
            <ReferenceField
            ...
            <TextField label="lugarinfo" source="lugarinfo" />
            <DateField source="updatedAt" label="Updated At" />
            <ReferenceField label="user" source="user.id" reference="User">
              <TextField source={USER_TITLE_FIELD} />
            </ReferenceField>
        ...
        >
          <Datagrid rowClick="show">
            ...
            <TextField label="price" source="price" />
            <TextField label="productinfo" source="productinfo" />
            <DateField source="updatedAt" label="Updated At" />
            <ReferenceField label="user" source="user.id" reference="User">
              <TextField source={USER_TITLE_FIELD} />
            </ReferenceField>
