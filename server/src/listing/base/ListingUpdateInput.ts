...
class ListingUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => EventoUpdateManyWithoutListingsInput,
  })
  @ValidateNested()
  @Type(() => EventoUpdateManyWithoutListingsInput)
  @IsOptional()
  @Field(() => EventoUpdateManyWithoutListingsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => LugarUpdateManyWithoutListingsInput,
  })
  @ValidateNested()
  @Type(() => LugarUpdateManyWithoutListingsInput)
  @IsOptional()
  @Field(() => LugarUpdateManyWithoutListingsInput, {
    nullable: true,
  })
