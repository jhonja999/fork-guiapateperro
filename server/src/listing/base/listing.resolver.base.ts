...
export class ListingResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Evento], { name: "eventos" })
  @nestAccessControl.UseRoles({
    resource: "Evento",
    action: "read",
    possession: "any",
  ...
  async findEventos(
    ...
    @graphql.Args() args: EventoFindManyArgs
  ): Promise<Evento[]> {
    const results = await this.service.findEventos(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Lugar], { name: "lugars" })
  @nestAccessControl.UseRoles({
    resource: "Lugar",
    action: "read",
    possession: "any",
