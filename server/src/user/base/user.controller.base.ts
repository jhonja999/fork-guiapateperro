...
import { EventoFindManyArgs } from "../../evento/base/EventoFindManyArgs";
import { Evento } from "../../evento/base/Evento";
import { EventoWhereUniqueInput } from "../../evento/base/EventoWhereUniqueInput";
...
export class UserControllerBase {
  ...
  async findEventos(
    ...
    const query = plainToClass(EventoFindManyArgs, request.query);
    const results = await this.service.findEventos(params.id, {
      ...query,
      select: {
        createdAt: true,
        eventoinfo: true,
  ...
  @common.Post("/:id/eventos")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectEventos(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: EventoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      eventos: {
        connect: body,
  ...
  @common.Delete("/:id/eventos")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectEventos(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: EventoWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  async findLugars(
    ...
    const query = plainToClass(LugarFindManyArgs, request.query);
    const results = await this.service.findLugars(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  async connectLugars(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: LugarWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      lugars: {
        connect: body,
  ...
  @common.Delete("/:id/lugars")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectLugars(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: LugarWhereUniqueInput[]
  ): Promise<void> {
    const data = {
